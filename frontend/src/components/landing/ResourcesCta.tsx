  ...
  return (
    <div className="rounded-xl bg-[#19161C] p-6 sm:p-8">
      ...
      <div className="mt-5 flex flex-wrap gap-3">
        <DeadLink className="inline-flex cursor-pointer items-center gap-2 rounded-full border border-zinc-700 px-5 py-2.5 text-xs font-semibold text-white transition hover:border-white hover:bg-white hover:text-black">
          YOUTUBE
